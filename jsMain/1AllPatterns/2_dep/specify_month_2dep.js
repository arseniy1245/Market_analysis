module.exports = (TF,month,requireScript,modeName,InrevalPerc,DeltPerc) => 
{
    console.log('\n' + '\n' + modeName + '\n');
    ...
    var h = 'Month;Profit;Pdown;Pup;Success;Loss;Total\n';
    ...
    h += `${month.join('-')};${((maxSum - 1)*100).toFixed(1)}%;${P1.toFixed(5)};${P2.toFixed(5)};${S};${L};${T}\n`;
    console.log(month.join('-'),((maxSum - 1)*100).toFixed(1)+'%', P1.toFixed(5),P2.toFixed(5),S,L,T);
